  ...
  return (
    <div
      className={classNames(
        'flex border border-tableBorder shadow-table min-h-table flex-col w-full rounded overflow-hidden',
        className
      )}
    >
            ...
            <tr>
              {headers.map((header, i) => (
                <th
                  ...
                  scope="col"
                  className={classNames(
                    'border border-t-0 border-tableBorder font-normal px-2 py-2 text-black text-center text-[18px]',
                    i === 0 && 'border-l-0',
                ...
                {headers.map((header, index) => {
                  ...
                  return (
                    <td
                      key={header.key}
                      className={classNames(
                        'min-h-[50px] border border-tableBorder px-2 py-2 text-black text-center text-[14px]',
      ...
      {pagination && (
        <div className="w-full pt-[20px] pb-[14px] px-[10px] flex bg-white justify-end">
