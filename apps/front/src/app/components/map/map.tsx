...
export const MapContext = React.createContext<(IMapContext & any) | void>(
  undefined
);
...
> {
  ...
  componentDidMount() {
    ...
    const mapContext: IMapContext = { map, selected: "" };
    this.setState({
    ...
    return (
      <div className="map" ref={this.mapDivRef}>
        {this.state.mapContext && (
          <MapContext.Provider
            value={{ ...this.state.mapContext, selected: this.props.selected }}
          >
            <VectorLayer />
          </MapContext.Provider>
        )}
